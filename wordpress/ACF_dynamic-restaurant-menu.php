...
?>
	...
	<div class="container" id="menuBody">
		<?php if( have_rows('menu') ): ?>
			<!-- BEGIN DYNAMIC RESTAURANT MENU -->
			<ul id="menuSelection">

			<?php while( have_rows('menu') ): the_row(); 
				// Dynamic Menu
				$menu_section = get_sub_field('section_name');
				// Create Dynamic Menu id's and for GET request
		...
		<!-- ACTIVE BUTTON COLOR CHANGE FOR DYNAMIC RESTAURANT MENU -->
		<script>
		...
		//IF NONE OF THE MENU ITEMS HAVE BEEN CLICKED, DIPSLAY THE FIRST ITEM'S MENU
		else
		{
